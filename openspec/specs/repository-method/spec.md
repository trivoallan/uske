...
## Purpose
L'état que le dépôt tient depuis qu'il est entré dans la méthode : une découverte aux objectifs
qualité ordonnés, des ADR hérités qui portent chacun un verdict vérifiable et la provenance de
leurs valeurs, et un document d'architecture que l'ADR d'architecture désigne.
